...
########################### Analyzing Shorts
def Prompter_shorts(descriptions,titles):
    system_prompt = """
     ...
     **Retourner la réponse structuré comme suit :
        {
            "type":'la categorie ici'
        }
    """
...
titre_video =  "Bells 2000 in action!"
description = ""
llmResponse = Prompter_shorts(description,titre_video)
json_string = llmResponse.choices[0].message.content
print(json_string)
